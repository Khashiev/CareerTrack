...
- определить твои карьерные ценности, которые напрямую влияют на выбор будущей компании и вакансии;  
...
По планированию карьеры и постановки целей можно использовать разные методики: 
...
Карьерную цель можно разбить на 2 периода для того, чтобы карьерный путь приобрел четкие планы, но при этом не забывать направление.   
...
1. Навыки, которыми вы владеете на текущий момент;  
...
4. Разбивайте карьерный план на 2-3 года вперед и 4-5 лет. Не забывайте каждый год сверяться со своим карьерным ростом. 
